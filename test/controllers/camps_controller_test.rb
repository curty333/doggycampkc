...
class CampsControllerTest < ActionController::TestCase
  ...
  test "should create camp" do
    assert_difference('Camp.count') do
      post :create, camp: { address: @camp.address, name: @camp.name, phone: @camp.phone, website: @camp.website }
    end
  ...
  test "should update camp" do
    patch :update, id: @camp, camp: { address: @camp.address, name: @camp.name, phone: @camp.phone, website: @camp.website }
    assert_redirected_to camp_path(assigns(:camp))
  end
